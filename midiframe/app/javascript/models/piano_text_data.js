...
// * 1. make piano text data as it works currently, compatible with this 
// * 2. save x and y movements into this data 
// * 3. save size into this data 
// * 4. save color into this data 
// * 5. save scalar into this data
// * 6. make ffmpeg.size,ffmpeg.color,ffmpeg.x,ffmpeg.y in table
// * make data format from server, check client window/og-video-width
// * make data format to server ditto
// * interpolate values in ffmpeg and voila
class PianoTextData {
