    ...
    `    <div data-controller="loading">
        ...
        <div data-target="loading.hide" id="page_content">
            <div data-controller="patterns--midi-device" id="page-container">
                <h3>dss/new pattern</h3>
                <h3 data-target="patterns--midi-device.channel patterns--midi-device.patternId patterns--midi-device.projectId" device-channel="4" pattern-id="5" project-id="16">4</h3>
                <div class="video-preview" data-controller="patterns--video">
                    ...
                    <video id="midi-video" class="video-js vjs-fluid" preload="auto" width="1000" data-target="patterns--video.video patterns--midi-device.video" controls>
                        <source src="/rails/active_storage/blobs/eyJfcmFpbHMiOnsibWVzc2FnZSI6IkJBaHBKQT09IiwiZXhwIjpudWxsLCJwdXIiOiJibG9iX2lkIn19--e7d43f82d61c40e626e2b7fa770489f1bac37fc0/outer.mp4" type="video/mp4" />
                    </video>
                </div>
                <div id="pattern-container">
                    <div
                        ...
                        note-stamps='{"53":268.984,"54":1262.43,"55":522.106,"56":658.661,"57":342.228,"58":824.854,"59":538.952,"60":1494.217,"61":556.946,"62":14.835,"63":2010.347,"64":1212.257,"65":523.214,"66":220.749,"67":1024.3,"68":937.146,"69":1688.385,"71":650.98,"72":1475.28,"73":799.238,"74":391.511,"75":1752.229,"76":1860.353}'
                        text-stamps="{}"
                    >
                        <ul class="set z-depth-5">
                            ...
                            <li class="white" data-target="patterns--keyboard.keyBoardKey patterns--midi-device.keyBoardKey" midi-note-number="53">
                                ...
                                <br />
                                <input class="key" data-action="click-&gt;patterns--midi-device#onPianoKeyClick" id="53" type="text" value="268.984" />
                            </li>
                            <li class="grey darken-4" data-target="patterns--keyboard.keyBoardKey patterns--midi-device.keyBoardKey" midi-note-number="54">
                                ...
                                <br />
                                <input class="key" data-action="click-&gt;patterns--midi-device#onPianoKeyClick" id="54" type="text" value="1262.43" />
                            </li>
                            <li class="white" data-target="patterns--keyboard.keyBoardKey patterns--midi-device.keyBoardKey" midi-note-number="55">
                                ...
                                <br />
                                <input class="key" data-action="click-&gt;patterns--midi-device#onPianoKeyClick" id="55" type="text" value="522.106" />
                            </li>
                            <li class="grey darken-4" data-target="patterns--keyboard.keyBoardKey patterns--midi-device.keyBoardKey" midi-note-number="56">
                                ...
                                <br />
                                <input class="key" data-action="click-&gt;patterns--midi-device#onPianoKeyClick" id="56" type="text" value="658.661" />
                            </li>
                            <li class="white" data-target="patterns--keyboard.keyBoardKey patterns--midi-device.keyBoardKey" midi-note-number="57">
                                ...
                                <br />
                                <input class="key" data-action="click-&gt;patterns--midi-device#onPianoKeyClick" id="57" type="text" value="342.228" />
                            </li>
                            <li class="grey darken-4" data-target="patterns--keyboard.keyBoardKey patterns--midi-device.keyBoardKey" midi-note-number="58">
                                ...
                                <br />
                                <input class="key" data-action="click-&gt;patterns--midi-device#onPianoKeyClick" id="58" type="text" value="824.854" />
                            </li>
                            <li class="white" data-target="patterns--keyboard.keyBoardKey patterns--midi-device.keyBoardKey" midi-note-number="59">
                                ...
                                <br />
                                <input class="key" data-action="click-&gt;patterns--midi-device#onPianoKeyClick" id="59" type="text" value="538.952" />
                            </li>
                            <li class="hide white" data-target="patterns--keyboard.keyBoardKey patterns--midi-device.keyBoardKey" midi-note-number="60">
                                ...
                                <br />
                                <input class="key" data-action="click-&gt;patterns--midi-device#onPianoKeyClick" id="60" type="text" value="1494.217" />
                            </li>
                            <li class="hide grey darken-4" data-target="patterns--keyboard.keyBoardKey patterns--midi-device.keyBoardKey" midi-note-number="61">
                                ...
                                <br />
                                <input class="key" data-action="click-&gt;patterns--midi-device#onPianoKeyClick" id="61" type="text" value="556.946" />
                            </li>
                            <li class="hide white" data-target="patterns--keyboard.keyBoardKey patterns--midi-device.keyBoardKey" midi-note-number="62">
                                ...
                                <br />
                                <input class="key" data-action="click-&gt;patterns--midi-device#onPianoKeyClick" id="62" type="text" value="14.835" />
                            </li>
                            <li class="hide grey darken-4" data-target="patterns--keyboard.keyBoardKey patterns--midi-device.keyBoardKey" midi-note-number="63">
                                ...
                                <br />
                                <input class="key" data-action="click-&gt;patterns--midi-device#onPianoKeyClick" id="63" type="text" value="2010.347" />
                            </li>
                            <li class="hide white" data-target="patterns--keyboard.keyBoardKey patterns--midi-device.keyBoardKey" midi-note-number="64">
                                ...
                                <br />
                                <input class="key" data-action="click-&gt;patterns--midi-device#onPianoKeyClick" id="64" type="text" value="1212.257" />
                            </li>
                            <li class="hide white" data-target="patterns--keyboard.keyBoardKey patterns--midi-device.keyBoardKey" midi-note-number="65">
                                ...
                                <br />
                                <input class="key" data-action="click-&gt;patterns--midi-device#onPianoKeyClick" id="65" type="text" value="523.214" />
                            </li>
                            <li class="hide grey darken-4" data-target="patterns--keyboard.keyBoardKey patterns--midi-device.keyBoardKey" midi-note-number="66">
                                ...
                                <br />
                                <input class="key" data-action="click-&gt;patterns--midi-device#onPianoKeyClick" id="66" type="text" value="220.749" />
                            </li>
                            <li class="hide white" data-target="patterns--keyboard.keyBoardKey patterns--midi-device.keyBoardKey" midi-note-number="67">
                                ...
                                <br />
                                <input class="key" data-action="click-&gt;patterns--midi-device#onPianoKeyClick" id="67" type="text" value="1024.3" />
                            </li>
                            <li class="hide grey darken-4" data-target="patterns--keyboard.keyBoardKey patterns--midi-device.keyBoardKey" midi-note-number="68">
                                ...
                                <br />
                                <input class="key" data-action="click-&gt;patterns--midi-device#onPianoKeyClick" id="68" type="text" value="937.146" />
                            </li>
                            <li class="hide white" data-target="patterns--keyboard.keyBoardKey patterns--midi-device.keyBoardKey" midi-note-number="69">
                                ...
                                <br />
                                <input class="key" data-action="click-&gt;patterns--midi-device#onPianoKeyClick" id="69" type="text" value="1688.385" />
                            </li>
                            ...
                            <li class="hide white" data-target="patterns--keyboard.keyBoardKey patterns--midi-device.keyBoardKey" midi-note-number="71">
                                ...
                                <br />
                                <input class="key" data-action="click-&gt;patterns--midi-device#onPianoKeyClick" id="71" type="text" value="650.98" />
                            </li>
                            <li class="hide white" data-target="patterns--keyboard.keyBoardKey patterns--midi-device.keyBoardKey" midi-note-number="72">
                                ...
                                <br />
                                <input class="key" data-action="click-&gt;patterns--midi-device#onPianoKeyClick" id="72" type="text" value="1475.28" />
                            </li>
                            <li class="hide grey darken-4" data-target="patterns--keyboard.keyBoardKey patterns--midi-device.keyBoardKey" midi-note-number="73">
                                ...
                                <br />
                                <input class="key" data-action="click-&gt;patterns--midi-device#onPianoKeyClick" id="73" type="text" value="799.238" />
                            </li>
                            <li class="hide white" data-target="patterns--keyboard.keyBoardKey patterns--midi-device.keyBoardKey" midi-note-number="74">
                                ...
                                <br />
                                <input class="key" data-action="click-&gt;patterns--midi-device#onPianoKeyClick" id="74" type="text" value="391.511" />
                            </li>
                            <li class="hide grey darken-4" data-target="patterns--keyboard.keyBoardKey patterns--midi-device.keyBoardKey" midi-note-number="75">
                                ...
                                <br />
                                <input class="key" data-action="click-&gt;patterns--midi-device#onPianoKeyClick" id="75" type="text" value="1752.229" />
                            </li>
                            <li class="hide white" data-target="patterns--keyboard.keyBoardKey patterns--midi-device.keyBoardKey" midi-note-number="76">
                                ...
                                <br />
                                <input class="key" data-action="click-&gt;patterns--midi-device#onPianoKeyClick" id="76" type="text" value="1860.353" />
                            </li>
                        ...
                        <div class="row">
                            ...
                            <a
                                ...
                                id="settings"
                                nav-url="/pattern-settings/5/16"
                            >
                                <i class="material-icons"> settings</i>
                            </a>
                            <a class="btn-floating btn-large waves-effect waves-light black lighten-2 z-depth-5" data-action="patterns--midi-device#saveCurrentTime" data-target="patterns--midi-device.saveCurrentTime" id="adjust">
                                <i class="material-icons"> adjust</i>
                            </a>
                            <a class="btn-floating btn-large waves-effect waves-light black lighten-2 z-depth-5" data-action="patterns--midi-device#addText" data-target="patterns--midi-device.addTextButton" id="format">
                                <i class="material-icons"> format_color_text</i>
                            </a>
                            <a class="btn-floating btn-large waves-effect waves-light teal lighten-2 z-depth-5" data-action="patterns--midi-device#randomizeAll" id="random_all"><i class="material-icons"> looks</i></a>
                            <a class="btn-floating btn-large waves-effect waves-light black lighten-2 z-depth-5" data-action="patterns--midi-device#randomizeOneNote" data-target="patterns--midi-device.randomizeOne" id="random_one">
