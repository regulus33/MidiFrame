...
import MidiRecorderContainer from './containers/MidiRecorderContainer.js'
...
class App extends React.Component {
  ...
  determineAppState(){
    ...
    if(this.state.showMidiRecorder === true) {
      return "SHOW_MIDI_RECORDER"
    }
  ...
  render(){
    ...
    if(appState === "SHOW_MIDI_RECORDER") {

      return <MidiRecorderContainer midiCollector={this.midiCollector} navigateToVideoSelectorContainer={this.navigateToVideoSelectorContainer} />
